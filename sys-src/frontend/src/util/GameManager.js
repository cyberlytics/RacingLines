...
export class GameManager{
    ...
    checkCollision(player, ctx) {
        for(let i = 0; i < 5; i++) {
            ...
            let posX = player.positionX + (player.size-2) * Math.cos(rad);
            let posY = player.positionY + (player.size-2) * Math.sin(rad);
            ...
            if(i > 0)
            {
                ...
                posX = player.positionX + (player.size-2) * Math.cos(rad);
                posY = player.positionY + (player.size-2) * Math.sin(rad);
